...
public class VillagerWorkshopMenu extends AbstractContainerMenu
{
    ...
    public VillagerWorkshopMenu(int containerId, Inventory playerInventory)
    {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public VillagerWorkshopMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess containerLevelAccess)
    {
    ...
    {
        return stillValid(this.access, player, BlockRegister.VILLAGER_WORKSHOP.get());
    }
    ...
    private void setupRecipeList(Container container, ItemStack stack)
    {
        ...
        if (!stack.isEmpty())
        {
            this.recipes = ((ServerLevel) this.level).recipeAccess().recipeMap().getRecipesFor(
                    RecipeTypeRegister.VILLAGER_WORKSHOP_RECIPE_TYPE.get(),
    ...
    public ItemStack quickMoveStack(Player pPlayer, int pIndex)
    {
        ...
        if (slot != null && slot.hasItem())
        {
            ...
            else if (((ServerLevel) this.level).recipeAccess().getRecipeFor(RecipeTypeRegister.VILLAGER_WORKSHOP_RECIPE_TYPE.get(), new SingleRecipeInput(itemstack1), this.level).isPresent())
            {
