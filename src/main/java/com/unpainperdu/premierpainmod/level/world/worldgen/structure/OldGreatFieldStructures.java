...
public class OldGreatFieldStructures extends Structure
{
    public static final MapCodec<OldGreatFieldStructures> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(OldGreatFieldStructures.settingsCodec(instance),
            ...
            ).apply(instance, OldGreatFieldStructures::new));
