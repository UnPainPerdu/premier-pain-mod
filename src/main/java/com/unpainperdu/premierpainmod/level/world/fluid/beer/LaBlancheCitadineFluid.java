...
public abstract class LaBlancheCitadineFluid extends BeerFluid
{
    ...
    {
        return FluidRegister.FLOWING_LA_BLANCHE_CITADINE_FLUID.get();
    }

    @Override
    public Fluid getSource()
    {
        return FluidRegister.LA_BLANCHE_CITADINE_FLUID.get();
    }

    @Override
    public FluidType getFluidType()
    {
        return FluidTypeRegister.LA_BLANCHE_CITADINE_TYPE.get();
    }

    @Override
    public Block getLiquidBlock()
    {
        return BlockRegister.LA_BLANCHE_CITADINE.get();
    }
