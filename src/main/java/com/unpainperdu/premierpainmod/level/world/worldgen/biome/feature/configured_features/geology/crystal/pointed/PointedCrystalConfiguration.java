...
public record PointedCrystalConfiguration(
...
) implements FeatureConfiguration
{
    ...
    public static final Codec<PointedCrystalConfiguration> CODEC = RecordCodecBuilder.create(
            builder -> builder.group(
                    ...
                    .apply(builder, PointedCrystalConfiguration::new)
    );
    ...
    public static class Builder
    {
        ...
        public PointedCrystalConfiguration build()
        {
            ...
            return new PointedCrystalConfiguration(this.spread, this.density, this.blockAndPointedAndCluster);
        }
    }
}