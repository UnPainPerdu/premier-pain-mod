...
public class PremierPainTempleStructures extends Structure
{
    public static final MapCodec<PremierPainTempleStructures> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(PremierPainTempleStructures.settingsCodec(instance),
            ...
            ).apply(instance, PremierPainTempleStructures::new));
    ...
    protected Optional<GenerationStub> findGenerationPoint(GenerationContext context)
    {
        ...
        if (!PremierPainTempleStructures.isSpawnable(context,startY))
        {
    ...
    {
        return StructureRegister.PREMIER_PAIN_TEMPLE_STRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}