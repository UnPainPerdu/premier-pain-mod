...
public class FluidTypeRegister
{
    ...
    public static void fluidTypeRegister(String name, String type, int tintColor, Vector4f fogColor)
    {
    ...
    public static void beerRegister(String name, int tintColor, Vector4f fogColor)
    {
    ...
    public static void oilRegister(String name, int tintColor, Vector4f fogColor)
    {
