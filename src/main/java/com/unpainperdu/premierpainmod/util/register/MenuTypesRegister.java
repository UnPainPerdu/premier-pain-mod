...
public class MenuTypesRegister
{
    ...
    public static final DeferredHolder<MenuType<?>,MenuType<VillagerBrewingStationMenu>> VILLAGER_BREWING_STATION = register("villager_brewing_station", () -> new MenuType(VillagerBrewingStationMenu::VillagerBrewingStationMenu, FeatureFlags.DEFAULT_FLAGS));
