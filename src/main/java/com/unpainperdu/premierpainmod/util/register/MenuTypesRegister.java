...
public class MenuTypesRegister
{
    ...
    public static final DeferredHolder<MenuType<?>,MenuType<VillagerDrawerMenu>> VILLAGER_DRAWER = register("villager_drawer", () -> new MenuType(VillagerDrawerMenu::new, FeatureFlags.DEFAULT_FLAGS));
