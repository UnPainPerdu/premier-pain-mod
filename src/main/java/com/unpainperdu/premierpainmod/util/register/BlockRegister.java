...
public class BlockRegister
{
    ...
    private static <T extends Block> DeferredBlock<T> pedestalRegister(String name, String type)
    {
        switch (type) {
            case "stone": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).noOcclusion()));
            }
            case "cobblestone": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.COBBLESTONE).noOcclusion()));
            }
            case "deepslate": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.COBBLED_DEEPSLATE).noOcclusion()));
            }
            case "tuff": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.TUFF).noOcclusion()));
            }
            case "mud": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PACKED_MUD).noOcclusion()));
            }
            case "sandstone": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SANDSTONE).noOcclusion()));
            }
            case "netherbrick": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_BRICKS).noOcclusion()));
            }
            case "mineral_weak": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LAPIS_BLOCK).noOcclusion()));
            }
            case "mineral_strong": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.COAL_BLOCK).noOcclusion()));
            }
            case "metal": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion()));
            }
            case "copper": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).noOcclusion()));
            }
            case "basalt": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BASALT).noOcclusion()));
            }
            case "endstone": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE).noOcclusion()));
            }
            case "obsidan": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OBSIDIAN).noOcclusion()));
            }
            case "netherite": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHERITE_BLOCK).noOcclusion()));
            }
            case "amethyst": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_BLOCK).noOcclusion()));
            }
            case "dripstone": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.DRIPSTONE_BLOCK).noOcclusion()));
            }
            case "bedrock": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BEDROCK).noOcclusion()));
            }
            case "netherwood": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CRIMSON_PLANKS).noOcclusion()));
            }
            case "cherry": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_PLANKS).noOcclusion()));
            }
            case "bamboo": {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BAMBOO_PLANKS).noOcclusion()));
            }
            default: {
                return (DeferredBlock<T>) registerBlock(name, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).noOcclusion()));
            }
        }
    }
