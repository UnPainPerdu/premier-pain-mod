...
public class BlockRegister
{
    ...
    public static final DeferredBlock<Block> OAK_VILLAGER_STATUE = BLOCKS.register("oak_villager_statue",() -> new VillagerStatue(BlockBehaviour.Properties.of().sound(SoundType.WOOD).noOcclusion().strength(2.0f)));
