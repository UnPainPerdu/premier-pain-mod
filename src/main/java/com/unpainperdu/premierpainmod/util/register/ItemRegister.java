...
public class ItemRegister
{
    ...
    //PainDieux
    public static final DeferredItem<Item> PAIN_DIEUX_BUCKET = ITEMS.register("pain_dieux_bucket", () -> new BucketItem(FLUIDS.get("pain_dieux_fluid").get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //LA_CHATEAU
    public static final DeferredItem<Item> LA_CHATEAU_BUCKET = ITEMS.register("la_chateau_bucket", () -> new BucketItem(FLUIDS.get("la_chateau_fluid").get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //DEBIER
    public static final DeferredItem<Item> DEBIER_BUCKET = ITEMS.register("debier_bucket", () -> new BucketItem(FLUIDS.get("debier_fluid").get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //ENVAHISSEUR_ROUGE
    public static final DeferredItem<Item> ENVAHISSEUR_ROUGE_BUCKET = ITEMS.register("envahisseur_rouge_bucket", () -> new BucketItem(FLUIDS.get("envahisseur_rouge_fluid").get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //RASPBUISSON
    public static final DeferredItem<Item> RASPBUISSON_BUCKET = ITEMS.register("raspbuisson_bucket", () -> new BucketItem(FLUIDS.get("raspbuisson_fluid").get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //LA_BLANCHE_CITADINE
    public static final DeferredItem<Item> LA_BLANCHE_CITADINE_BUCKET = ITEMS.register("la_blanche_citadine_bucket", () -> new BucketItem(FLUIDS.get("la_blanche_citadine_fluid").get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //CRANE_NOIR
    public static final DeferredItem<Item> CRANE_NOIR_BUCKET = ITEMS.register("crane_noir_bucket", () -> new BucketItem(FLUIDS.get("crane_noir_fluid").get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //TAK
    public static final DeferredItem<Item> TAK_BUCKET = ITEMS.register("tak_bucket", () -> new BucketItem(FLUIDS.get("tak_fluid").get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //DISENDER
    public static final DeferredItem<Item> DISENDER_BUCKET = ITEMS.register("disender_bucket", () -> new BucketItem(FLUIDS.get("disender_fluid").get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
