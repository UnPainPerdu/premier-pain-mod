...
public class ItemRegister
{
    ...
    public static final DeferredItem<Item>  TUFF_VILLAGER_SHELF = ITEMS.register("tuff_villager_shelf", () -> new VillagerShelfItem(new Item.Properties(),BlockRegister.PACKED_MUD_STANDING_VILLAGER_SHELF.get(),BlockRegister.PACKED_MUD_WALL_VILLAGER_SHELF.get()));
    public static final DeferredItem<Item>  PACKED_MUD_VILLAGER_SHELF = ITEMS.register("packed_mud_villager_shelf", () -> new VillagerShelfItem(new Item.Properties(),BlockRegister.OAK_STANDING_VILLAGER_SHELF.get(),BlockRegister.OAK_WALL_VILLAGER_SHELF.get()));
    ...
    public static final DeferredItem<Item>  QUARTZ_BLOCK_VILLAGER_SHELF = ITEMS.register("quartz_block_villager_shelf", () -> new VillagerShelfItem(new Item.Properties(),BlockRegister.PURPUR_BLOCK_STANDING_VILLAGER_SHELF.get(),BlockRegister.PURPUR_BLOCK_WALL_VILLAGER_SHELF.get()));
    ...
    public static final DeferredItem<Item>  DRIPSTONE_BLOCK_VILLAGER_SHELF = ITEMS.register("dripstone_villager_shelf", () -> new VillagerShelfItem(new Item.Properties(),BlockRegister.DRIPSTONE_BLOCK_STANDING_VILLAGER_SHELF.get(),BlockRegister.DRIPSTONE_BLOCK_WALL_VILLAGER_SHELF.get()));
