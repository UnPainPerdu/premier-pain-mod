...
import static com.unpainperdu.premierpainmod.util.register.fluid.AllInOneFluidRegister.getFluidFromRegisteredFluidName;
...
public class ItemRegister
{
    ...
    //fluid
    //oil
    public static final DeferredItem<Item> MORICHE_PALM_OIL_BUCKET = ITEMS.register("moriche_palm_oil_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(MorichePalmOilFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    //beer
    //empty
    ...
    //PainDieux
    public static final DeferredItem<Item> PAIN_DIEUX_BUCKET = ITEMS.register("pain_dieux_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(PainDieuxFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //LA_CHATEAU
    public static final DeferredItem<Item> LA_CHATEAU_BUCKET = ITEMS.register("la_chateau_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(LaChateauFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //DEBIER
    public static final DeferredItem<Item> DEBIER_BUCKET = ITEMS.register("debier_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(DeBierFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //ENVAHISSEUR_ROUGE
    public static final DeferredItem<Item> ENVAHISSEUR_ROUGE_BUCKET = ITEMS.register("envahisseur_rouge_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(EnvahisseurRougeFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //RASPBUISSON
    public static final DeferredItem<Item> RASPBUISSON_BUCKET = ITEMS.register("raspbuisson_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(RaspBuissonFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //LA_BLANCHE_CITADINE
    public static final DeferredItem<Item> LA_BLANCHE_CITADINE_BUCKET = ITEMS.register("la_blanche_citadine_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(LaBlancheCitadineFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //CRANE_NOIR
    public static final DeferredItem<Item> CRANE_NOIR_BUCKET = ITEMS.register("crane_noir_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(CraneNoirFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //TAK
    public static final DeferredItem<Item> TAK_BUCKET = ITEMS.register("tak_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(TakFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    //DISENDER
    public static final DeferredItem<Item> DISENDER_BUCKET = ITEMS.register("disender_bucket", () -> new BucketItem(getFluidFromRegisteredFluidName(DisEnderFluid.NAME).getFirst().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
